...
if ( ! is_front_page() || ht\get_page_excerpt( get_the_ID() ) !== '' ) :
	?>
	<section class="header-hero hero <?php if ( is_front_page() ) : ?>is-medium<?php endif; ?> <?php if ( has_post_thumbnail() ) : ?>is-dark<?php else : ?>is-light<?php endif; ?>" data-component="parallax">
